...
class FragAddDespesa : CustomFrag() {
    ...
    // TODO: add uma view pra coletar a data em que a despesa foi paga
    ...
    private fun mostrarBottomSheetRepetir(callback: (Int, String, Recorrencia.Tipo?) -> Any) {
        BottomSheetRepetir(callback, this@FragAddDespesa,viewModel.qtdRepeticoes,viewModel.tipoRecorrencia).mostrar()
    }
    ...
    private fun initCampoData() {
        ...
        binding.dataPgto.addTextChangedListener(MascaraData.mascaraData())
    }
